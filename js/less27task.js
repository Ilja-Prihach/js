...
// Вызов функции getMathResult(3, 10) даст ответ 3---6---9---12---15---18---21---24---27---3
...
//task 3
function getMathResult (num, mathDegree) {
    if (typeof(mathDegree) !== 'number' || mathDegree <= 0) {
        return num;
    }
    let str = '';
    for (let i = 1; i <= mathDegree; i++) {
        if (i === mathDegree) {
            str += `${num * i}`;
        } else {
            str +=`${num * i}---`;
